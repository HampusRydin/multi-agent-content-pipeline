  ...
  return (
    <div className="min-h-screen bg-black py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="bg-gray-900 border border-gray-700 rounded-lg shadow-lg p-6 space-y-6">
          <div>
            <label htmlFor="prd" className="block text-sm font-medium text-gray-300 mb-2">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-black text-white placeholder-gray-500 resize-y"
            />
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-black text-white placeholder-gray-500"
            />
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label htmlFor="target_length" className="block text-sm font-medium text-gray-300 mb-2">
                Target Length (words)
              </label>
              <input
                type="number"
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-black text-white"
              />
            </div>
          ...
          <div className="flex gap-4 pt-4">
            <button
              ...
              className="flex-1 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-700 disabled:cursor-not-allowed text-white font-medium py-3 px-6 rounded-lg transition-colors"
            >
              {loading ? (
